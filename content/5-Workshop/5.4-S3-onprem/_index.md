---
title : "S3, RDS, Secrets Manager, and IAM"
date : 2024-01-01
weight : 4
chapter : false
pre : " <b> 5.4. </b> "
...
1. [Create S3 Buckets, Upload the Artifact, and Configure the Gateway Endpoint](5.4.1-prepare/)
2. [Create Private Amazon RDS for MySQL](5.4.2-rds/)
3. [Create the Application Secret in Secrets Manager](5.4.3-secrets-manager/)
4. [Create the EC2 IAM Role](5.4.4-iam-role/)
