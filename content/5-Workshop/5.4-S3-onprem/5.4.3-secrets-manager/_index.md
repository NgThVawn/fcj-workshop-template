---
title : "Create the Application Secret in Secrets Manager"
date : 2024-01-01
weight : 3
chapter : false
pre : " <b> 5.4.3 </b> "
...
1. **Start creating the secret**
   ...
   ![Start creating the secret](/images/5-Workshop/5.4-S3-onprem/secrets-manager-01.png)
...
2. **Select the secret type and enter key/value pairs**
   ...
   ![Select the secret type and enter key/value pairs](/images/5-Workshop/5.4-S3-onprem/secrets-manager-02.png)
...
3. **Complete the environment variables**
   ...
   ![Complete the environment variables](/images/5-Workshop/5.4-S3-onprem/secrets-manager-03.png)
...
4. **Name the secret**
   ...
   ![Name the secret](/images/5-Workshop/5.4-S3-onprem/secrets-manager-04.png)
...
5. **Configure rotation**
   ...
   ![Configure secret rotation](/images/5-Workshop/5.4-S3-onprem/secrets-manager-05.png)
...
6. **Review and store the secret**
   ...
   ![Review and store the secret](/images/5-Workshop/5.4-S3-onprem/secrets-manager-06.png)
...
7. **Confirm that the secret exists**
   ...
   ![Confirm that the secret exists](/images/5-Workshop/5.4-S3-onprem/secrets-manager-07.png)
