---
title : "S3, RDS, Secrets Manager và IAM"
date : 2024-01-01
weight : 4
chapter : false
pre : " <b> 5.4. </b> "
...
1. [Tạo S3 bucket, upload artifact và cấu hình Gateway Endpoint](5.4.1-prepare/)
2. [Tạo RDS MySQL private](5.4.2-rds/)
3. [Tạo Secrets Manager cho cấu hình ứng dụng](5.4.3-secrets-manager/)
4. [Tạo IAM Role cho EC2](5.4.4-iam-role/)
