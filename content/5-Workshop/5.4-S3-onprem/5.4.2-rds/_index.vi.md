...
1. **Mở chức năng tạo DB subnet group**
   ...
   ![Bắt đầu tạo DB subnet group](/images/5-Workshop/5.4-S3-onprem/rds-01.png)
...
2. **Khởi tạo DB subnet group**
   ...
   ![Mở danh sách Subnet groups](/images/5-Workshop/5.4-S3-onprem/rds-02.png)
...
3. **Nhập thông tin DB subnet group**
   ...
   ![Nhập thông tin DB subnet group](/images/5-Workshop/5.4-S3-onprem/rds-03.png)
...
4. **Chọn AZ và private DB subnets**
   ...
   ![Chọn AZ và private DB subnets](/images/5-Workshop/5.4-S3-onprem/rds-04.png)
...
5. **Bắt đầu tạo database MySQL**
   ...
   ![Bắt đầu tạo database MySQL](/images/5-Workshop/5.4-S3-onprem/rds-05.png)
...
6. **Chọn template và availability**
   ...
   ![Chọn template và availability](/images/5-Workshop/5.4-S3-onprem/rds-06.png)
...
7. **Đặt tên database và credentials**
   ...
   ![Đặt tên database và credentials](/images/5-Workshop/5.4-S3-onprem/rds-07.png)
...
8. **Chọn instance class**
   ...
   ![Chọn instance class](/images/5-Workshop/5.4-S3-onprem/rds-08.png)
...
9. **Cấu hình storage**
   ...
   ![Cấu hình storage](/images/5-Workshop/5.4-S3-onprem/rds-09.png)
...
10. **Chọn network cho RDS**
   ...
   ![Chọn network cho RDS](/images/5-Workshop/5.4-S3-onprem/rds-10.png)
...
11. **Tắt public access và chọn Security Group**
   ...
   ![Tắt public access và chọn Security Group](/images/5-Workshop/5.4-S3-onprem/rds-11.png)
...
12. **Cấu hình monitoring**
   ...
   ![Cấu hình monitoring](/images/5-Workshop/5.4-S3-onprem/rds-12.png)
...
13. **Đặt database name và port**
   ...
   ![Đặt database name và port](/images/5-Workshop/5.4-S3-onprem/rds-13.png)
...
14. **Cấu hình backup**
   ...
   ![Cấu hình backup](/images/5-Workshop/5.4-S3-onprem/rds-14.png)
...
15. **Rà soát chi phí và tạo database**
   ...
   ![Rà soát chi phí và tạo database](/images/5-Workshop/5.4-S3-onprem/rds-15.png)
...
16. **Theo dõi trạng thái database**
   ...
   ![Theo dõi trạng thái database](/images/5-Workshop/5.4-S3-onprem/rds-16.png)
...
17. **Kiểm tra endpoint và network**
   ...
   ![Kiểm tra endpoint và network](/images/5-Workshop/5.4-S3-onprem/rds-17.png)
