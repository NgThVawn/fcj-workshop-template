---
title : "Create Private Amazon RDS for MySQL"
date : 2024-01-01
weight : 2
chapter : false
pre : " <b> 5.4.2 </b> "
...
1. **Open the DB subnet group workflow**
   ...
   ![Start creating the DB subnet group](/images/5-Workshop/5.4-S3-onprem/rds-01.png)
...
2. **Initialize the DB subnet group**
   ...
   ![Open the Subnet groups list](/images/5-Workshop/5.4-S3-onprem/rds-02.png)
...
3. **Enter DB subnet group details**
   ...
   ![Enter DB subnet group details](/images/5-Workshop/5.4-S3-onprem/rds-03.png)
...
4. **Select Availability Zones and private database subnets**
   ...
   ![Select Availability Zones and private database subnets](/images/5-Workshop/5.4-S3-onprem/rds-04.png)
...
5. **Start creating the MySQL database**
   ...
   ![Start creating the MySQL database](/images/5-Workshop/5.4-S3-onprem/rds-05.png)
...
6. **Select the template and availability option**
   ...
   ![Select the template and availability option](/images/5-Workshop/5.4-S3-onprem/rds-06.png)
...
7. **Set the database identifier and credentials**
   ...
   ![Set the database identifier and credentials](/images/5-Workshop/5.4-S3-onprem/rds-07.png)
...
8. **Select the DB instance class**
   ...
   ![Select the DB instance class](/images/5-Workshop/5.4-S3-onprem/rds-08.png)
...
9. **Configure storage**
   ...
   ![Configure RDS storage](/images/5-Workshop/5.4-S3-onprem/rds-09.png)
...
10. **Select the RDS network**
   ...
   ![Select the RDS network](/images/5-Workshop/5.4-S3-onprem/rds-10.png)
...
11. **Disable public access and select the Security Group**
   ...
   ![Disable public access and select the Security Group](/images/5-Workshop/5.4-S3-onprem/rds-11.png)
...
12. **Configure monitoring**
   ...
   ![Configure RDS monitoring](/images/5-Workshop/5.4-S3-onprem/rds-12.png)
...
13. **Set the database name and port**
   ...
   ![Set the database name and port](/images/5-Workshop/5.4-S3-onprem/rds-13.png)
...
14. **Configure backups**
   ...
   ![Configure RDS backups](/images/5-Workshop/5.4-S3-onprem/rds-14.png)
...
15. **Review cost and create the database**
   ...
   ![Review cost and create the database](/images/5-Workshop/5.4-S3-onprem/rds-15.png)
...
16. **Monitor the database status**
   ...
   ![Monitor the database status](/images/5-Workshop/5.4-S3-onprem/rds-16.png)
...
17. **Verify the endpoint and network**
   ...
   ![Verify the RDS endpoint and network](/images/5-Workshop/5.4-S3-onprem/rds-17.png)
