---
title : "Tạo S3, upload artifact và cấu hình Gateway Endpoint"
date : 2024-01-01
weight : 1
chapter : false
pre : " <b> 5.4.1 </b> "
...
1. **Mở chức năng tạo S3 bucket**
   ...
   ![Mở chức năng tạo S3 bucket](/images/5-Workshop/5.4-S3-onprem/s3-01.png)
...
2. **Nhập tên và Region cho artifact bucket**
   ...
   ![Nhập tên và Region cho artifact bucket](/images/5-Workshop/5.4-S3-onprem/s3-02.png)
...
3. **Giữ Block Public Access và tạo bucket**
   ...
   ![Giữ Block Public Access và tạo artifact bucket](/images/5-Workshop/5.4-S3-onprem/s3-03.png)
...
4. **Kiểm tra artifact bucket sau khi tạo**
   ...
   ![Kiểm tra artifact bucket sau khi tạo](/images/5-Workshop/5.4-S3-onprem/s3-04.png)
...
5. **Đóng gói tệp JAR phát hành**
   ...
   ![Đóng gói tệp JAR phát hành của SportBooking](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-01.png)
...
6. **Mở artifact bucket**
   ...
   ![Mở artifact bucket đã tạo](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-02.png)
...
7. **Tạo prefix releases**
   ...
   ![Tạo prefix releases trong artifact bucket](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-03.png)
...
8. **Bắt đầu upload artifact**
   ...
   ![Bắt đầu upload artifact jar](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-04.png)
...
9. **Chọn file jar từ máy cục bộ**
   ...
   ![Chọn file jar để upload](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-05.png)
...
10. **Xác nhận đích upload**
   ...
   ![Xác nhận đích upload artifact](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-06.png)
...
11. **Kiểm tra artifact upload thành công**
   ...
   ![Kiểm tra artifact upload thành công](/images/5-Workshop/5.4-S3-onprem/s3-artifact-upload-07.png)
