...
1. **Bắt đầu tạo IAM Role**
   ...
   ![Bắt đầu tạo IAM Role](/images/5-Workshop/5.4-S3-onprem/iam-role-01.png)
...
2. **Chọn trusted entity là EC2**
   ...
   ![Chọn trusted entity là EC2](/images/5-Workshop/5.4-S3-onprem/iam-role-02.png)
...
3. **Tìm policy cần gắn**
   ...
   ![Tìm policy cần gắn](/images/5-Workshop/5.4-S3-onprem/iam-role-03.png)
...
4. **Tạo policy quyền ứng dụng**
   ...
   ![Tạo policy quyền ứng dụng](/images/5-Workshop/5.4-S3-onprem/iam-role-04.png)
...
5. **Đặt tên và tạo policy**
   ...
   ![Đặt tên và tạo policy](/images/5-Workshop/5.4-S3-onprem/iam-role-05.png)
...
6. **Quay lại bước chọn permissions**
   ...
   ![Quay lại bước chọn permissions](/images/5-Workshop/5.4-S3-onprem/iam-role-06.png)
...
7. **Gắn policy vào role**
   ...
   ![Gắn policy vào role](/images/5-Workshop/5.4-S3-onprem/iam-role-07.png)
...
8. **Đặt tên role**
   ...
   ![Đặt tên role](/images/5-Workshop/5.4-S3-onprem/iam-role-08.png)
...
9. **Rà soát và tạo role**
   ...
   ![Rà soát và tạo role](/images/5-Workshop/5.4-S3-onprem/iam-role-09.png)
...
10. **Xác nhận role đã sẵn sàng**
   ...
   ![Xác nhận role đã sẵn sàng](/images/5-Workshop/5.4-S3-onprem/iam-role-10.png)
