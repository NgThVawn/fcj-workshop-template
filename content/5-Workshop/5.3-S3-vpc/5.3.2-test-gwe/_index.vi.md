...
1. **Mở danh sách Security Groups**
   ...
   ![Mở danh sách Security Groups](/images/5-Workshop/5.3-S3-vpc/security-groups-01.png)
...
2. **Cấu hình Security Group cho ALB**
   ...
   ![Cấu hình Security Group cho ALB](/images/5-Workshop/5.3-S3-vpc/security-groups-02.png)
...
3. **Hoàn tất tạo Security Group cho ALB**
   ...
   ![Hoàn tất tạo Security Group cho ALB](/images/5-Workshop/5.3-S3-vpc/security-groups-03.png)
...
4. **Xác nhận Security Group đã tạo**
   ...
   ![Xác nhận Security Group đã tạo](/images/5-Workshop/5.3-S3-vpc/security-groups-04.png)
...
5. **Giới hạn outbound từ ALB đến ứng dụng**
   ...
   ![Giới hạn outbound từ ALB đến ứng dụng](/images/5-Workshop/5.3-S3-vpc/security-groups-05.png)
