---
title : "Tạo VPC, subnet và route table"
date : 2024-01-01
weight : 1
chapter : false
pre : " <b> 5.3.1 </b> "
...
1. **Mở trang tạo VPC**
   ...
   ![Mở màn hình tạo VPC](/images/5-Workshop/5.3-S3-vpc/vpc-01.png)
...
2. **Chọn chế độ VPC and more**
   ...
   ![Chọn kiểu tạo VPC and more](/images/5-Workshop/5.3-S3-vpc/vpc-02.png)
...
3. **Cấu hình số AZ, subnet public/private và NAT**
   ...
   ![Cấu hình số AZ, subnet public/private và NAT](/images/5-Workshop/5.3-S3-vpc/vpc-03.png)
...
4. **Kiểm tra lại cấu hình trước khi tạo**
   ...
   ![Kiểm tra lại cấu hình trước khi tạo](/images/5-Workshop/5.3-S3-vpc/vpc-04.png)
...
5. **Theo dõi tiến trình Create VPC workflow**
   ...
   ![Theo dõi tiến trình Create VPC workflow](/images/5-Workshop/5.3-S3-vpc/vpc-05.png)
...
6. **Hoàn tất workflow**
   ...
   ![Hoàn tất workflow](/images/5-Workshop/5.3-S3-vpc/vpc-06.png)
...
7. **Kiểm tra Resource map của VPC**
   ...
   ![Kiểm tra Resource map của VPC](/images/5-Workshop/5.3-S3-vpc/vpc-07.png)
